...
const val PASSWORD_REGEXP = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d]{6,}$"
const val INVALID_PASSWORD_MESSAGE = "Minimum eight characters, at least one uppercase letter, one lowercase letter and one number"
